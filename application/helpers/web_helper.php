...
if (!function_exists('allowheader')) {
	...
	{
		#$thisdomain = 'kkn.ummada.ac.id';
		#$allow = [
		#	$thisdomain,
		#];
		
		// Mendapatkan domain secara dinamis dari request
		$thisdomain = $_SERVER['HTTP_HOST'];

		// Menambahkan domain yang diizinkan
		$allow = [
			'kkn.ummada.ac.id',
			'kkn.stfmuhammadiyahcirebon.ac.id',
		];
...
if (!function_exists('setupgoogle')) {
	function setupgoogle()
	{
		...
		$CI->google->setRedirectUri('https://kkn.ummada.ac.id/login');
