                ...
                <table class="table table-striped table-sm table-jadwal">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Pembimbing</th>
                            <th style="vertical-align: middle;" scope="col">Jenis Kelamin</th>
                            <th style="vertical-align: middle;" scope="col">HP/ Email</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="formkelompok">
                <input type="hidden" name="idkelompok" id="idkelompok">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <label>Kelompok</label>
                                <input type="text" class="form-control validate[required]" id="namakelompok" name="namakelompok">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Lokasi</label>
                                <select class="form-select validate[required] vselect2" id="idlokasi" name="idlokasi"></select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-select validate[required] vselect2" id="idpembimbing_kkn" name="idpembimbing_kkn"></select>
                            </div>
                        </div>
                    </div>
