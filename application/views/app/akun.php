                ...
                <table class="table table-striped table-sm table-data">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Nama/ NIK</th>
                            <th style="vertical-align: middle;" scope="col">Tempat/ Tgl Lahir</th>
                            <th style="vertical-align: middle;" scope="col">Alamat/ HP/ Email</th>
                            <th style="vertical-align: middle;" scope="col">Aktivasi</th>
                            <th style="vertical-align: middle;" scope="col">Grup Akun</th>
            ...
            <form id="formweb">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select validate[required]" id="kel" name="kel"></select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Tempat Lahir</label>
                                <input type="text" class="form-control validate[required]" id="tmplahir" name="tmplahir">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Tanggal Lahir</label>
                                <input type="text" class="form-control validate[required] datepicker" id="tgllahir" name="tgllahir">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Jalan Rumah</label>
                                <textarea class="form-control validate[required]" rows="3" id="alamat" name="alamat"></textarea>
                                <div style="font-size:12px">Tanpa menuliskan kelurahan, kecamatan, kabupaten dan provinsi</div>
                            </div>
                        </div>
                    </div>
                    <div id="check-password" style="display: none;"><input type="checkbox" id="gantipass" name="gantipass" value="1"> Input Password</div>
                                ...
                                <div class=" row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control validate[required,minSize[8]]" id="pass1" name="pass1"></input>
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label>Ulangi Password</label>
                                            <input type="password" class="form-control validate[required,equals[pass1]]" id="pass2" name="pass2"></input>
                                        </div>
                                    </div>
                                </div>
                            </div>
