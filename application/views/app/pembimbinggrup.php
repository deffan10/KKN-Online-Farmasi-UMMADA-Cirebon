                ...
                <table class="table table-striped table-sm table-jadwal">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">NIP</th>
                            <th style="vertical-align: middle;" scope="col">Email</th>
                            <th style="vertical-align: middle;" scope="col">Status Pegawai</th>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control validate[required]" id="nip" name="nip">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
