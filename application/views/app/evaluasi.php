                ...
                <table class="table table-striped table-sm table-jadwal">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Tujuan</th>
                            <th style="vertical-align: middle;" scope="col">Judul</th>
                            <th style="vertical-align: middle;" scope="col">Link</th>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tujuan</label>
                                <select class="form-select validate[required]" id="tujuan" name="tujuan"></select>
                            </div>
                        </div>
                    </div>
