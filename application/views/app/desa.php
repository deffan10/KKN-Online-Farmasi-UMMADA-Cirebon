...
<section class="section">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-4">
                    <select class="form-select" id="idprovinsi" name="idprovinsi"></select>
                </div>
                <div class="col-4">
                    <select class="form-select" id="idkabupaten" name="idkabupaten"></select>
                </div>
                <div class="col-4">
                    <select class="form-select" id="idkecamatan" name="idkecamatan"></select>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-striped table-sm table-data">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Kode</th>
                            <th style="vertical-align: middle;" scope="col">Kelurahan/ Desa</th>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control validate[required]" id="kodewilayah_prov" name="kodewilayah_prov">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Kode Kab</label>
                                <input type="number" class="form-control validate[required]" id="kodewilayah_kab" name="kodewilayah_kab">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Kode Kab</label>
                                <input type="number" class="form-control validate[required]" id="kodewilayah_kec" name="kodewilayah_kec">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Kode Kab</label>
                                <input type="number" class="form-control validate[required]" id="kode" name="kode">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Kelurahan/ Desa</label>
                                <input type="text" class="form-control validate[required]" id="desa" name="desa">
                            </div>
                        </div>
                    </div>
                </div>
