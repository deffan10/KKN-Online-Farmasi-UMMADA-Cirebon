                ...
                <table class="table table-striped table-sm table-jadwal">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Kabupaten/Provinsi</th>
                            <th style="vertical-align: middle;" scope="col">Pergi</th>
                            <th style="vertical-align: middle;" scope="col">Pulang</th>
...
<!-- Modal web -->
<div class="modal fade text-left w-100" id="modal-form-lokasi" tabindex="-1" role="dialog" aria-labelledby="myModalForm" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select validate[required] vselect2" id="idprovinsi" name="idprovinsi"></select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Kabupaten</label>
                                <select class="form-select validate[required] vselect2" id="idkabupaten" name="idkabupaten"></select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Kecamatan</label>
                                <select class="form-select validate[required] vselect2" id="idkecamatan" name="idkecamatan"></select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Kelurahan/ Desa</label>
                                <select class="form-select validate[required] vselect2" id="iddesa" name="iddesa"></select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Pergi</label>
                                <input type="text" class="form-control validate[required] appcurrency" id="pergi" name="pergi">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Pulang</label>
                                <input type="text" class="form-control validate[required] appcurrency" id="pulang" name="pulang">
                            </div>
                        </div>
                    </div>
