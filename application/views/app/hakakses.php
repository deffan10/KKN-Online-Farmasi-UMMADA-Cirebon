                ...
                <table class="table table-striped table-sm table-data">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Create</th>
                            <th style="vertical-align: middle;" scope="col">Read</th>
                            <th style="vertical-align: middle;" scope="col">Update</th>
                            <th style="vertical-align: middle;" scope="col">Detele</th>
                            <th style="vertical-align: middle;" scope="col">Full</th>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Create</label>
                                <select class="form-select validate[required]" id="c" name="c"></select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Read</label>
                                <select class="form-select validate[required]" id="r" name="r"></select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Update</label>
                                <select class="form-select validate[required]" id="u" name="u"></select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Delete</label>
                                <select class="form-select validate[required]" id="d" name="d"></select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Full Akses</label>
                                <select class="form-select validate[required]" id="f" name="f"></select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
