                ...
                <table class="table table-striped table-sm table-jadwal">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Thumbnail</th>
                            <th style="vertical-align: middle;" scope="col">Judul</th>
                            <th style="vertical-align: middle;" scope="col">Slug</th>
                            <th style="vertical-align: middle;" scope="col">Penulis</th>
...
<!-- Modal web -->
<div class="modal fade text-left w-100" id="modal-form-berita" tabindex="-1" role="dialog" aria-labelledby="myModalForm" aria-hidden="true">
