...
<p class="auth-subtitle mb-5">Login menggunakan akun yang sudah terdaftar</p>
...
<div class="text-center mt-5 text-lg fs-4">
    <p class="text-gray-600">Belum punya akun? <a href="<?= base_url("daftar") ?>" class="font-bold">Daftar</a>.</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control validate[required,custom[email]]" id="email_lupa" name="email_lupa" placeholder="email terdaftar anda sim-kkn UMMADA Cirebon">
