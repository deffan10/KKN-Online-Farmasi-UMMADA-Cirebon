...
<p class="auth-subtitle mb-5">Silahkan mengisi form berikut untuk mendaftaran di website ini.</p>
<form id="formregister">
    ...
    <div class="form-group position-relative has-icon-left mb-4">
        <input type="text" class="form-control form-control-xl validate[required,custom[email]]" id="email" name="email" placeholder="Email @gmail.com">
        <div class="form-control-icon">
    ...
    <div class="form-group position-relative has-icon-left mb-4">
        <input type="number" class="form-control form-control-xl validate[required,minSize[10],maxSize[13]]" id="hp" name="hp" placeholder="Nomor HP">
        <div class="form-control-icon">
    ...
    <div class="form-group position-relative has-icon-left mb-4">
        <select name="idgrup" id="idgrup" class="form-select select_grup validate[required]" style="padding-left: 3rem; padding-right: 2.5rem; font-size: 1.2rem; padding-top: 0.85rem; padding-bottom: 0.85rem;">
...
<div class="text-center mt-5 text-lg fs-4">
    <p class="text-gray-600 loadin">Sudah ada akun ? <a href="<?= base_url('login') ?>" class="font-bold">Masuk</a>.</p>
