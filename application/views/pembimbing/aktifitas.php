...
<div class="page-title mb-2">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3><?= $web['title'] ?> Kelompok <?= $kelompok['namakelompok'] ?></h3>
            <div class="text-subtitle text-muted"><?= $web['title'] ?> pada sistem terintegrasi</div>
            <div style="font-size:13px;"><i class="bi bi-pin-map-fill"></i> Lokasi <?= $kelompok['provinsi'] . ", " . $kelompok['kabupaten'] . ", " . $kelompok['kecamatan'] . ", Kelurahan " . $kelompok['desa'] ?></div>
        </div>
                ...
                <table class="table table-striped table-sm table-jadwal">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle;" scope="col">Aktifitas</th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-control" id="editoraktifitas" name="aktifitas"></div>
                            </div>
                        </div>
                    </div>
