...
class Kecamatan extends CI_Controller
{
    private $d = array(
        ...
        "web" => array(
            "title" => "Kecamatan",
            "parent" => array(""),
            "modul" => "master/kecamatan",
            "view"  => "master/kecamatan",
            "page"    => "Kecamatan",
        ),
    );
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/data";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/jadwal.js?' . date("ymdhis")),
        );
