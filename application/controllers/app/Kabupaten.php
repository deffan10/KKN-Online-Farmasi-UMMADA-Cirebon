...
class Kabupaten extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/kabupaten";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/kabupaten.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->select("
            ...
            k.id, k.kabupaten, k.idprovinsi, p.provinsi,
            CONCAT(k.kodewilayah_prov,'.',k.kode) as kode,
		");

        $this->datatables->from("wilayah_kab as k");
