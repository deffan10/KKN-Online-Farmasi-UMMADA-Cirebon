...
class Fakultas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/fakultas";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/fakultas.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->select("
            ...
            f.id, f.fakultas
		");
        $this->datatables->from("mst_fakultas as f");
    ...
    public function simpan()
    {
        ...
        $this->form_validation->set_rules('fakultas', 'nama fakultas', 'trim|required');
