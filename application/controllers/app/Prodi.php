...
class Prodi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/prodi";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/prodi.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->join("mst_fakultas as f", "f.id=p.idfakultas", "left");
        $idfakultas = ($idfakultas != "") ? $idfakultas : -1;
        $this->datatables->where("f.id", $idfakultas);
    ...
    public function simpan()
    {
        ...
        $this->form_validation->set_rules('idfakultas', 'fakultas', 'trim|required');
