...
class Monitoring extends CI_Controller
{
    private $d = array(
        ...
        "web" => array(
            "title" => "Monitoring",
            "parent" => array(""),
            "modul" => "app/monitoring",
            "view"  => "app",
            "page"  => "Monitoring Aktifitas",
        ),
    );
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/monitoring";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/monitoring.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        foreach ($retVal['data'] as $index => $dp) {
            ...
            $tmp['nilai_input'] = "<input title='0 sd 100' type='number' class='form-control validate[required] nilaimhs' style='width:85px;' data-idnilai='" . $dp['idnilai2'] . "' data-idpenempatan='" . $dp['idpenempatan'] . "' data-idmst_penilaian='2'  value='" . $dp['nilai_angka2'] . "'>
                                    <div class='btn-group mt-3' role='group' style='font-size:12px'>
                                        ...
                                        <a title='Output' target='blank_' href='" . base_url("file/detail_output/" . $dp['idpenempatan']) . "' class='btn btn-secondary'><i class='bi bi-paperclip'></i> </a>
                                    </div>";
