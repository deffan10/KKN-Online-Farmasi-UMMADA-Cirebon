...
class Masteroutput extends CI_Controller
{
    private $d = array(
        "tbName" => "mst_output",
        "otentikasi" => array(),
        "primaryKey" => "id",
        "web" => array(
            "title" => "Output Peserta",
            "parent" => array("pengaturan"),
            "modul" => "app/masteroutput",
            "view"  => "app",
            "page"  => "masteroutput",
        ),
    );
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/masteroutput";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/masteroutput.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->select("
            ...
            m.id, m.output, m.urut
		");
        $this->datatables->from("mst_output as m");
