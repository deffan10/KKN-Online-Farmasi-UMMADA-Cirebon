...
class Jabatanpeserta extends CI_Controller
{
    private $d = array(
        "tbName" => "mst_jabatan",
        "otentikasi" => array(),
        "primaryKey" => "id",
        "web" => array(
            "title" => "Jabatan Peserta",
            "parent" => array("pengaturan"),
            "modul" => "app/jabatanpeserta",
            "view"  => "app",
            "page"  => "jabatanpeserta",
        ),
    );
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/jabatanpeserta";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/jabatanpeserta.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->select("
            ...
            m.id, m.jabatan, m.urut
		");
        $this->datatables->from("mst_jabatan as m");
    ...
    public function simpan()
    {
        ...
        $this->form_validation->set_rules('jabatan', 'jabatan peserta', 'trim|required');
        $this->form_validation->set_rules('urut', 'no. urut', 'trim|required');
