...
class Provinsi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/provinsi";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/provinsi.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->select("
            ...
            w.id, w.provinsi,
            CAST(w.kode as SIGNED) AS kode,
		");
        $this->datatables->from("wilayah_prov as w");
