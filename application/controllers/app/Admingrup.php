...
class Admingrup extends CI_Controller
{
    private $d = array(
        "tbName" => "hakakses",
        "idgrup" => "1",
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/admingrup";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/admingrup.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->join("admin as a", "h.id=a.idhakakses", "left");
        ...
        if ($this->form_validation->run()) {
            ...
            if ($id == "" && akses_akun("insert", $this->otentikasi)->status) {
                ...
                if ($retVal['status']) {
                    ...
                    $retVal = $this->Model_data->save($dataGrup, "admin", null, true);
                }
