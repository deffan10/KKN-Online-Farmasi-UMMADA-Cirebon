...
class masterpenilai extends CI_Controller
{
    private $d = array(
        "tbName" => "mst_penilaian",
        "otentikasi" => array(),
        "primaryKey" => "id",
        "web" => array(
            "title" => "Master Penilaian",
            "parent" => array("pengaturan"),
            "modul" => "app/masterpenilai",
            "view"  => "app",
            "page"  => "masterpenilai",
        ),
    );
    ...
    public function index()
    {
        ...
        $this->d['web']['loadview'] = $this->d['web']['view'] . "/masterpenilai";
        ...
        $this->d['web']['importJs'] = array(
            base_url('assets/web/app/masterpenilai.js?' . date("ymdhis")),
        );
    ...
    public function read()
    {
        ...
        $this->datatables->select("
            ...
            m.id, m.jenis, m.urut
		");
        $this->datatables->from("mst_penilaian as m");
    ...
    public function simpan()
    {
        ...
        $this->form_validation->set_rules('jenis', 'jenis penilai', 'trim|required');
