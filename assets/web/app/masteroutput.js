...
function loadTabel() {
    dtTable = $('.table').DataTable({
        ...
        "ajax": {
            "url": vBase_url + "app/masteroutput/read",
            "dataType": "json",
            "type": "POST",
...
$("#formweb").submit(function(e) {
    ...
    let formVal = {
        id: $("#formweb #id").val(),
        output: $("#formweb #output").val(),
        urut: $("#formweb #urut").val(),
    };
    if ($('#formweb').validationEngine('validate')) {
        appAjax("app/masteroutput/simpan", formVal).done(function(vRet) {
...
$(document).on("click",".editRow", function(e) {
    ...
    appAjax("api/carigeneral", formVal).done(function(dataLoad) {
        if (dataLoad.status) {
            ...
            $("#formweb #output").val(dtweb.output);
...
$(document).on("click",".deleteRow", function(e) {
    ...
    fDelete(submitVal, "app/masteroutput/delete");
});
