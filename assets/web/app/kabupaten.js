...
function loadTabel() {
    dtTable = $('.table').DataTable({
        ...
        "ajax": {
            "url": vBase_url + "app/kabupaten/read",
            "dataType": "json",
            "type": "POST",
            "data": function (d) {
...
function tambahForm() {
    if($("#idprovinsi").val()==""){
        showNotification(false,["Pilih provinsi terlebih dahulu"]);    
    }else{
...
$("#formweb").submit(function(e) {
    ...
    let formVal = {
            ...
            kabupaten: $("#formweb #kabupaten").val(),
            idprovinsi: $("#idprovinsi").val(),
    };
    if ($('#formweb').validationEngine('validate')) {
        appAjax("app/kabupaten/simpan", formVal).done(function(vRet) {
    ...
    if($("#idprovinsi").val()==""){
        ...
        appAjax("api/carigeneral", formVal).done(function(dataLoad) {
            if (dataLoad.status) {
                ...
                $("#formweb #kabupaten").val(dtweb.kabupaten);
...
$(document).on("click",".deleteRow", function(e) {
    ...
    fDelete(submitVal, "app/kabupaten/delete");
});
