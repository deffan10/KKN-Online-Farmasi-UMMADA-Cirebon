...
function loadTabel() {
    dtTable = $('.table').DataTable({
        ...
        "ajax": {
            "url": vBase_url + "app/masterpenilai/read",
            "dataType": "json",
            "type": "POST",
...
$("#formweb").submit(function(e) {
    ...
    let formVal = {
        id: $("#formweb #id").val(),
        jenis: $("#formweb #jenis").val(),
        urut: $("#formweb #urut").val(),
    };
    if ($('#formweb').validationEngine('validate')) {
        appAjax("app/masterpenilai/simpan", formVal).done(function(vRet) {
...
$(document).on("click",".deleteRow", function(e) {
    ...
    fDelete(submitVal, "app/masterpenilai/delete");
});
