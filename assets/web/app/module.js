...
$("#formweb").submit(function(e) {
    ...
    let formVal = {
            ...
            deskripsi: $("#formweb #deskripsi").val(),
    };
    if ($('#formweb').validationEngine('validate')) {
        appAjax("app/module/simpan", formVal).done(function(vRet) {
...
$(document).on("click",".editRow", function(e) {
    ...
    appAjax("api/carigeneral", formVal).done(function(dataLoad) {
        if (dataLoad.status) {
            ...
            $("#formweb #deskripsi").val(dtweb.deskripsi);
...
$(document).on("click",".deleteRow", function(e) {
    ...
    fDelete(submitVal, "app/module/delete");
});
