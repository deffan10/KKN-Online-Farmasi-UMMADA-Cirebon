        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "* Permisi, ini harus diisi",
                    "alertTextCheckboxMultiple": "* Jangan lupa untuk kita pilih",
                    "alertTextCheckboxe": "* Kotak centang ini juga tetap harus dipilih",
                    "alertTextDateRange": "* rentang tanggal ini tidak boleh kosong nah"
                },
                "requiredInFunction": { 
                    "func": function(field, rules, i, options){
                        return (field.val() == "test") ? true : false;
                    },
                    "alertText": "* Harus sama, tidak boleh beda"
                },
                "dateRange": {
                    "regex": "none",
                ...
                "groupRequired": {
                    "regex": "none",
                    "alertText": "* kita harus wajib isi  salah satu isiannya"
                },
                "min": {
                    "regex": "none",
                ...
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "* bukan nilai bulat kita isi"
                },
                "number": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^[\-\+]?((([0-9]{1,3})([,][0-9]{3})*)|([0-9]+))?([\.]([0-9]+))?$/,
                    "alertText": "* bukan nilai desimal kita isi"
                },
                "date": {
                    ...
                    "func": function (field) {
                     ...
                     "alertText": "* format tanggal ta salah, harus dalam format TTTT-BB-HH"
                },
                "ipv4": {
